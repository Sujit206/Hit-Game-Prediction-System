...
<div class="footer">
    ...
    <p class="foot-parag" style="font-size: 0.8rem; margin-top: 1rem;">© 2024 Hit Game Predictor | Powered by Machine Learning</p>
</div>
""", unsafe_allow_html=True)
...
#     <!-- Floating particles -->
#     <div class="particles">
#         <div class="    " style="width: 4px; height: 4px; left: 10%; animation-delay: 0s;"></div>
#         <div class="particle" style="width: 6px; height: 6px; left: 20%; animation-delay: 1s;"></div>
#         <div class="particle" style="width: 3px; height: 3px; left: 30%; animation-delay: 2s;"></div>
#         <div class="particle" style="width: 5px; height: 5px; left: 40%; animation-delay: 3s;"></div>
#         <div class="particle" style="width: 4px; height: 4px; left: 50%; animation-delay: 4s;"></div>
...
#     text-align: center;
#     padding: 2.5rem 0;
#     background: linear-gradient(135deg, #2d3561 0%, #0f3460 100%);
#     color: white;
#     border-radius: 25px;
#     margin-bottom: 2.5rem;
...
# <div class="main-header">
#     <h1>� Hit Game Classification System</h1>
#     <p>Advanced ML-powered prediction for gaming success</p>
# </div>
# """, unsafe_allow_html=True)

# st.markdown("""
# <div class="hero-card">
#     <h2>🚀 Welcome to the Future of Game Prediction!</h2>
#     <p>Our sophisticated machine learning model analyzes platform, genre, publisher, and release year to predict whether a game will become a hit. With 81% ROC-AUC accuracy, you're getting industry-leading insights.</p>
# </div>
# """, unsafe_allow_html=True)
...
#         result_class = "success-result" if prediction == 1 else "warning-result"
#         emoji = "🔥" if prediction == 1 else "⚠️"
#         status = "HIT GAME!" if prediction == 1 else "NOT A HIT"
...
#             <div class="metric-label">Success Probability: {probability:.2%}</div>
#             <div style="margin: 1rem 0;">
#                 <div style="background: rgba(255,255,255,0.3); border-radius: 10px; padding: 0.5rem;">
#                     <div style="background: rgba(255,255,255,0.6); height: 20px; border-radius: 8px; width: {probability*100}%;"></div>
#                 </div>
#             </div>
#             <p><strong>Decision Threshold:</strong> {THRESHOLD:.2f}</p>
#             <p><strong>Verdict:</strong> {'This game shows strong potential for success!' if prediction == 1 else 'This game may need additional marketing support to succeed.'}</p>
...
#         with col2:
#             st.metric("Status", "HIT" if prediction == 1 else "NOT HIT")
#         with col3:
#             st.metric("Confidence", "High" if probability > 0.8 else "Medium" if probability > 0.6 else "Low")
...
#     <p>Logistic Regression | ROC-AUC: 0.81 | Decision Threshold: 0.7</p>
#     <p>Trained on historical video game data for accurate hit prediction</p>
#     <p style="font-size: 0.8rem; margin-top: 1rem;">© 2024 Hit Game Predictor | Powered by Machine Learning</p>
# </div>
# """, unsafe_allow_html=True)
# import joblib
